...
public interface WalletsService {
     ...
     * Create Wallet.
     * <p>
     * Create a wallet. Note: The first ONCHAIN wallet for each network family must be created
     ...
     * <p>
     * Creates a new deposit address for a wallet. Only applicable to wallets that support
     * multiple deposit addresses on a given network
     * </p>
     *
     * @param request the request parameters for this operation
     * @return the response payload for this operation
