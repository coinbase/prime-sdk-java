...
public class OptionProductDetails {
   ...
   * Contract never expires - SETTLEMENT_PERIOD_DAY: Contract expires daily -
   * SETTLEMENT_PERIOD_WEEK: Contract expires weekly - SETTLEMENT_PERIOD_MONTH: Contract expires
   * monthly
   */
  ...
  /**
   * Tiered price increments that override price_increment above a threshold; empty when a single
   * price_increment applies
   */
