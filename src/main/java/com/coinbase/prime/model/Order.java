...
public class Order {
  ...
  /**
   * A client-generated order ID used for reference purposes (note: order will be rejected if this
   * ID is not unique among all currently active orders)
   */
  ...
  /**
   * The expiry time of the order in UTC (applies to TWAP, VWAP, LIMIT, and STOP_LIMIT orders with
   * &#x60;time_in_force&#x60; set to &#x60;GTD&#x60;)
   */
  @JsonProperty("expiry_time")
  private OffsetDateTime expiryTime;

  /**
   * - UNKNOWN_ORDER_STATUS: nil value - OPEN: The order is open but unfilled - FILLED: The order
   * was filled - CANCELLED: The order was cancelled - EXPIRED: The order has expired - FAILED:
   * Order submission failed - PENDING: The order has been sent but is not yet confirmed
   */
  @JsonProperty("status")
  ...
  /**
   * Total commission paid on this order (in quote asset units) -- only applicable for partially- or
   * fully-filled orders
   */
  ...
  /**
   * Fee charged by the exchange for Cost Plus commission configurations. Exchange fee will be 0 for
   * All In commission configurations.
   */
  ...
  /**
   * Indicates a user friendly message for regarding various aspects of the order such as
   * cancellation or rejection reasons
   */
