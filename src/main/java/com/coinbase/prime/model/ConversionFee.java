...
/**
 * Per-pair conversion fee row: month-to-date net conversion volume and the applicable progressive
 * fee tiers for an organization.
 */
public class ConversionFee {
  ...
  /**
   * Month-to-date net conversion volume denominated in from_currency, aggregated at the owning
   * organization level. Positive &#x3D; net from->to, negative &#x3D; net to->from.
   */
  @JsonProperty("net_conversion_volume_mtd")
  private String netConversionVolumeMtd;

  /**
   * Progressive fee tiers applicable to this organization for this pair. Tiers are ordered from
