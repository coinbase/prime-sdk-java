...
public class TransferLocation {
  /**
   * - TRANSFER_LOCATION_TYPE_UNKNOWN: The nil value - PAYMENT_METHOD: The ID of a fiat payment
   * method - WALLET: The ID of a wallet - ADDRESS: A cryptocurrency address - OTHER: Another type
