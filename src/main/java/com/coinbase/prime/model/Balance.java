...
public class Balance {
  ...
  /**
   * Amount that is currently locked due to bonding/staking, potentially subject to an unbonding
  ...
  /**
   * ETH staking rewards currently available to claim, in whole units. This field is returned only
   * in GetWalletBalance responses for ETH wallets. It is omitted or empty for portfolio-level
   * responses and for non-ETH assets; use pending_rewards_amount where applicable.
   */
