...
public class Allocation {
  ...
  /**
   * The ID of the allocation if this allocation is a reversal. In this case, the root_id would be
   * the original allocation ID.
   */
  ...
  /**
   * All order IDs that were aggregated to calculate the avg_price, quantity to allocate in each
   * leg. Each order_id should tie back to the single allocation root_id.
   */
  @JsonProperty("order_ids")
  private List<String> orderIds;

  /**
   * Array of objects, each containing the leg ID, destination portfolio ID and amount in chosen
   * units allocated to each portfolio: [{leg_id, portfolio_id, allocation_base, allocation_quote},
   * {leg_id, portfolio_id, allocation_base, allocation_quote}...]
   */
  private List<DestinationAlloc> destinations;

  /**
   * The netting ID of the allocation, not empty if the allocation was submitted as part of a net
   * allocation
   */
