 ...
 */
public class CreatePortfolioUnstakeRequest {
    ...
    public CreatePortfolioUnstakeRequest() {
    }

    public CreatePortfolioUnstakeRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public CreatePortfolioUnstakeRequest build() throws CoinbaseClientException {
            validate();
            return new CreatePortfolioUnstakeRequest(this);
        }
