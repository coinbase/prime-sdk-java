 ...
 */
public class CreatePortfolioStakeRequest {
    ...
    public static class Builder {
        ...
        public CreatePortfolioStakeRequest build() throws CoinbaseClientException {
            validate();
            return new CreatePortfolioStakeRequest(this);
        }
