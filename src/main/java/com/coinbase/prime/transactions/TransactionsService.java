...
public interface TransactionsService {
   ...
   *
   * <p>List transactions for a given portfolio
   *
   ...
   *
   * <p>Retrieve a specific transaction by its transaction ID
   *
   * @param request the request parameters for this operation
   * @return the response payload for this operation
   * @throws CoinbaseClientException if the request fails client-side validation
   ...
   * Create Conversion.
   *
   * <p>Perform a conversion between 2 assets
   *
   * @param request the request parameters for this operation
   * @return the response payload for this operation
   * @throws CoinbaseClientException if the request fails client-side validation
   ...
   *
   * <p>Create an onchain transaction
   *
   * @param request the request parameters for this operation
   * @return the response payload for this operation
   * @throws CoinbaseClientException if the request fails client-side validation
   * @throws CoinbasePrimeException if the Prime API returns an error response
   */
  CreateOnchainTransactionResponse createOnchainTransaction(CreateOnchainTransactionRequest request)
      throws CoinbaseClientException, CoinbasePrimeException;

  /**
   * List Wallet Transactions.
   *
   * <p>Retrieve transactions for a given wallet
   *
   * @param request the request parameters for this operation
   * @return the response payload for this operation
   * @throws CoinbaseClientException if the request fails client-side validation
   ...
   * @throws CoinbasePrimeException if the Prime API returns an error response
   */
  CreateWalletTransferResponse createWalletTransfer(CreateWalletTransferRequest request)
      throws CoinbaseClientException, CoinbasePrimeException;

  /**
   * Create Withdrawal.
   *
   * <p>Create a withdrawal
   *
   * @param request the request parameters for this operation
   * @return the response payload for this operation
   * @throws CoinbaseClientException if the request fails client-side validation
   * @throws CoinbasePrimeException if the Prime API returns an error response
   */
  CreateWalletWithdrawalResponse createWalletWithdrawal(CreateWalletWithdrawalRequest request)
      throws CoinbaseClientException, CoinbasePrimeException;

  /**
   * Get Transaction Travel Rule Data.
   *
   * <p>(Beta) Get fulfilled travel rule data for a transaction
   *
   * @param request the request parameters for this operation
   * @return the response payload for this operation
   * @throws CoinbaseClientException if the request fails client-side validation
   ...
   *
   * <p>Submit travel rule data for an existing deposit transaction
   *
   * @param request the request parameters for this operation
   * @return the response payload for this operation
   * @throws CoinbaseClientException if the request fails client-side validation
   * @throws CoinbasePrimeException if the Prime API returns an error response
   */
  SubmitDepositTravelRuleDataResponse submitDepositTravelRuleData(
