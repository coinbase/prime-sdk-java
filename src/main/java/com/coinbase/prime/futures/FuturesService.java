...
public interface FuturesService {
     ...
     * <p>
     * Schedule a sweep for a given entity from FCM wallet to USD Spot wallet. Only one pending
     ...
     * <p>
     * Cancel the pending sweep for a given entity. A user will only be able to have one
     * pending sweep at a time. If the sweep is not found, a 404 will be returned
     * </p>
     *
     * @param request the request parameters for this operation
     * @return the response payload for this operation
