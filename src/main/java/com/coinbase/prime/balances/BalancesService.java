...
public interface BalancesService {
   ...
   *
   * <p>List all balances for a specific entity
   *
   ...
   */
  ListEntityBalancesResponse listEntityBalances(ListEntityBalancesRequest request)
   ...
   * Get Wallet Balance.
   *
   * <p>Query balance for a specific wallet
   *
   * @param request the request parameters for this operation
   * @return the response payload for this operation
   * @throws CoinbaseClientException if the request fails client-side validation
   ...
   *
   * <p>Query balances for a specific onchain wallet
   *
   * @param request the request parameters for this operation
   * @return the response payload for this operation
   * @throws CoinbaseClientException if the request fails client-side validation
   * @throws CoinbasePrimeException if the Prime API returns an error response
   */
  ListOnchainWalletBalancesResponse listOnchainWalletBalances(
