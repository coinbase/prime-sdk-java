...
public interface FinancingService {
     ...
     * <p>
     * Get trade finance tiered pricing fees for a given entity at a specific time, default to
     * current time
     * </p>
     *
     * @param request the request parameters for this operation
     ...
     * <p>
     * Returns the size of a buy trade that can be performed based on existing holdings and
     * available credit. The result will differ for different assets due to asset specific
     * credit configurations and caps. Note that this result is changing based on asset price
     * fluctuations, so may be rejected when submitted
     * </p>
     *
     * @param request the request parameters for this operation
     * @return the response payload for this operation
     ...
     * <p>
     * Lists conversions and short collateral requirement between specified date range. This
     ...
     * <p>
     * Returns the nominal quantity of a given asset that can be withdrawn based on holdings
     * and current portfolio equity
     * </p>
     *
     * @param request the request parameters for this operation
     * @return the response payload for this operation
