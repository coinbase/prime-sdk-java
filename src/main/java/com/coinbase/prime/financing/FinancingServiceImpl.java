...
public class FinancingServiceImpl extends CoinbaseServiceImpl implements FinancingService {
  private final CoinbasePrimeClient primeClient;
  ...
  @Override
  public ListInterestAccrualsResponse listInterestAccruals(ListInterestAccrualsRequest request)
  ...
  public GetCrossMarginOverviewResponse getCrossMarginOverview(
      GetCrossMarginOverviewRequest request) throws CoinbasePrimeException {
    return this.request(
        HttpMethod.GET,
  ...
  public GetEntityLocateAvailabilitiesResponse getEntityLocateAvailabilities(
      GetEntityLocateAvailabilitiesRequest request) throws CoinbasePrimeException {
    return this.request(
        HttpMethod.GET,
  ...
  @Override
  public GetMarginInformationResponse getMarginInformation(GetMarginInformationRequest request)
      throws CoinbasePrimeException {
    return this.request(
        HttpMethod.GET,
  ...
  public ListMarginCallSummariesResponse listMarginCallSummaries(
      ListMarginCallSummariesRequest request) throws CoinbasePrimeException {
    return this.request(
        HttpMethod.GET,
  ...
  public ListTradeFinanceObligationsResponse listTradeFinanceObligations(
      ListTradeFinanceObligationsRequest request) throws CoinbasePrimeException {
    return this.request(
        HttpMethod.GET,
  ...
  public GetTradeFinanceTieredPricingFeesResponse getTradeFinanceTieredPricingFees(
      GetTradeFinanceTieredPricingFeesRequest request) throws CoinbasePrimeException {
    return this.request(
        HttpMethod.GET,
  ...
  public ListInterestAccrualsForPortfolioResponse listInterestAccrualsForPortfolio(
      ListInterestAccrualsForPortfolioRequest request) throws CoinbasePrimeException {
    return this.request(
        HttpMethod.GET,
  ...
  public GetPortfolioBuyingPowerResponse getPortfolioBuyingPower(
      GetPortfolioBuyingPowerRequest request) throws CoinbasePrimeException {
    return this.request(
        HttpMethod.GET,
  ...
  public GetPortfolioCreditInformationResponse getPortfolioCreditInformation(
      GetPortfolioCreditInformationRequest request) throws CoinbasePrimeException {
    return this.request(
        HttpMethod.GET,
  ...
  @Override
  public ListExistingLocatesResponse listExistingLocates(ListExistingLocatesRequest request)
      throws CoinbasePrimeException {
    return this.request(
        HttpMethod.GET,
  ...
  @Override
  public CreateNewLocatesResponse createNewLocates(CreateNewLocatesRequest request)
      throws CoinbasePrimeException {
    return this.request(
        HttpMethod.POST,
        String.format("/portfolios/%s/locates", request.getPortfolioId()),
  ...
  @Override
  public ListMarginConversionsResponse listMarginConversions(ListMarginConversionsRequest request)
      throws CoinbasePrimeException {
    return this.request(
        HttpMethod.GET,
  ...
  public GetPortfolioWithdrawalPowerResponse getPortfolioWithdrawalPower(
      GetPortfolioWithdrawalPowerRequest request) throws CoinbasePrimeException {
    return this.request(
        HttpMethod.GET,
  ...
  @Override
  public UpdateFundingSettingsResponse updateFundingSettings(UpdateFundingSettingsRequest request)
      throws CoinbasePrimeException {
    return this.request(
        HttpMethod.POST,
  ...
  public GetCrossMarginRiskParametersResponse getCrossMarginRiskParameters(
      GetCrossMarginRiskParametersRequest request) throws CoinbasePrimeException {
    return this.request(
        HttpMethod.GET,
  ...
  /**
   * This endpoint is served from {@code /v2}; we swap the version on the base URL for this call
   * only without mutating the shared client (same pattern as prime-sdk-go {@code
   * WithBaseUrl}/{@code VersionedBaseUrl}).
   */
  @Override
  public GetCrossMarginPrimeOverviewResponse getCrossMarginPrimeOverview(
      GetCrossMarginPrimeOverviewRequest request) throws CoinbasePrimeException {
    CoinbasePrimeClient v2Client =
        primeClient.withBaseUrl(Constants.versionedBaseUrl(Constants.CB_PRIME_BASE_URL, "v2"));
    return new CoinbaseServiceImpl(v2Client) {}.request(
        HttpMethod.GET,
        String.format("/entities/%s/cross_margin/prime", request.getEntityId()),
        request,
        List.of(200),
  ...
  @Override
  public GetMarketDataResponse getMarketData(GetMarketDataRequest request)
      throws CoinbasePrimeException {
    return this.request(
        HttpMethod.GET,
