...
public class CoinbasePrimeCredentials implements CoinbaseCredentials {
  ...
  public CoinbasePrimeCredentials(String accessKey, String passphrase, String signingKey)
  ...
  public CoinbasePrimeCredentials(
      String accessKey, String passphrase, String signingKey, String svcAccountId)
      throws CoinbaseClientException {
    if (isNullOrEmpty(accessKey)) {
      throw new CoinbaseClientException("Access key is required");
    }
    ...
    if (isNullOrEmpty(svcAccountId)) {
      throw new CoinbaseClientException(
          "Service account id is required if you want to use WebSockets");
    }
