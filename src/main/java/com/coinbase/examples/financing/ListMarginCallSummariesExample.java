...
import com.coinbase.prime.financing.ListMarginCallSummariesRequest;
import com.coinbase.prime.financing.ListMarginCallSummariesResponse;
import com.fasterxml.jackson.databind.ObjectMapper;

public class ListMarginCallSummariesExample {
    ...
    try {
      ...
      ListMarginCallSummariesResponse response =
          service.listMarginCallSummaries(
              new ListMarginCallSummariesRequest.Builder().entityId(entityId).build());
