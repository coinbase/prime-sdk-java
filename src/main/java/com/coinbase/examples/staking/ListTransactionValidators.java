...
import com.coinbase.prime.staking.ListTransactionValidatorsRequest;
import com.coinbase.prime.staking.ListTransactionValidatorsResponse;
  ...
  public static void main(String[] args) {
    try {
      ...
      String transactionId =
          args.length > 0 ? args[0] : System.getenv("COINBASE_PRIME_TRANSACTION_ID");
