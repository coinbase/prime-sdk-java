...
import com.coinbase.prime.staking.CreateUnstakeRequest;
import com.coinbase.prime.staking.CreateUnstakeResponse;
import com.coinbase.prime.staking.StakingService;
import com.fasterxml.jackson.databind.ObjectMapper;
import java.util.UUID;

public class CreateUnstake {
  public static void main(String[] args) {
    try {
      ...
      CreateUnstakeResponse response =
          service.createUnstake(
