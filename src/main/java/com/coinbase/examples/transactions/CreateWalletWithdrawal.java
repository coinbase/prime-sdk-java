...
public class CreateWalletWithdrawal {
  public static void main(String[] args) {
    try {
      if (args.length < 4) {
        System.err.println(
            "Usage: CreateWalletWithdrawal <wallet-id> <amount> <currency-symbol> <destination-address>");
        System.err.println(
            "Example: CreateWalletWithdrawal wallet-id-123 0.01 ETH 0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb");
        System.exit(1);
      }
      ...
      BlockchainAddress blockchainAddress =
          new BlockchainAddress.Builder().address(destinationAddress).build();

      System.out.println(
          "Creating blockchain withdrawal: Portfolio ID: "
              + portfolioId
              + ", Wallet: "
              + walletId
              + ", Amount: "
      ...
      CreateWalletWithdrawalResponse response =
          service.createWalletWithdrawal(
