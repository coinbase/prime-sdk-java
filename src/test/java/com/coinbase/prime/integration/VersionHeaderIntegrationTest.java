...
/**
 * Integration test to verify the version header functionality works correctly from end-to-end in
 * the prime-sdk-java implementation.
 */
public class VersionHeaderIntegrationTest {
  ...
  public void testVersionHeaderMatchesPomVersion() throws CoinbaseClientException {
    ...
    assertEquals(
        "prime-sdk-java/1.11.0",
        userAgent,
        "User-Agent should contain 'prime-sdk-java/1.11.0' to match pom.xml version");
  ...
  public void testSdkVersionConstantMatches() {
    ...
    assertEquals(
        ...
        "SDK_VERSION constant should be '1.11.0' to match pom.xml version");
  }
  ...
  public void testAllApiCallsWillIncludeVersionHeader() throws CoinbaseClientException {
    ...
    String[] testPaths = {
      "/v1/portfolios", "/v1/orders", "/v1/activities", "/v1/wallets", "/v1/transactions"
    };
