 ...
 *
 * <ul>
 *   <li>COINBASE_PRIME_CREDENTIALS - JSON with accessKey, passphrase, signingKey
 *   <li>COINBASE_PRIME_PORTFOLIO_ID - portfolio UUID used in portfolio-scoped calls
 *   <li>COINBASE_PRIME_ENTITY_ID - entity UUID used in entity-scoped calls
 * </ul>
 *
 * <p>Optional per-feature overrides (used when a subclass declares {@link #featureScope()}):
 *
 * <ul>
 *   <li>COINBASE_PRIME_FUTURES_CREDENTIALS / _PORTFOLIO_ID / _ENTITY_ID
 *   <li>COINBASE_PRIME_FINANCING_CREDENTIALS / _PORTFOLIO_ID / _ENTITY_ID
 * </ul>
 *
...
public abstract class BaseIntegrationTest {
  ...
  /**
   * When non-null, integration config is resolved from COINBASE_PRIME_{scope}_* env vars with
   * fallback to the default COINBASE_PRIME_* vars.
   */
  ...
  public void setUpBase() throws Exception {
    ...
    assumeTrue(
        credentialsJson != null && !credentialsJson.isEmpty(),
        scope != null
            ? "Skipping integration test: COINBASE_PRIME_"
                + scope
