...
public class FuturesIT extends BaseIntegrationTest {
  ...
  public void testGetEntityFcmBalance() throws Exception {
    ...
    GetEntityFcmBalanceResponse response =
        service.getEntityFcmBalance(
            new GetEntityFcmBalanceRequest.Builder().entityId(entityId).build());
  ...
  public void testGetFcmMarginCallDetails() throws Exception {
    ...
    GetFcmMarginCallDetailsResponse response =
        service.getFcmMarginCallDetails(
            new GetFcmMarginCallDetailsRequest.Builder().entityId(entityId).build());
    assertNotNull(response);
  }
  ...
  public void testGetPositions() throws Exception {
    ...
    GetPositionsResponse response =
        service.getPositions(new GetPositionsRequest.Builder().entityId(entityId).build());
    assertNotNull(response);
  }
  ...
  public void testGetFcmRiskLimits() throws Exception {
    ...
    GetFcmRiskLimitsResponse response =
        service.getFcmRiskLimits(new GetFcmRiskLimitsRequest.Builder().entityId(entityId).build());
    assertNotNull(response);
  }
  ...
  public void testGetFcmSettings() throws Exception {
    assumeTrue(
        entityId != null && !entityId.isEmpty(), "Skipping: COINBASE_PRIME_ENTITY_ID not set");
    FuturesService service = PrimeServiceFactory.createFuturesService(client);
    GetFcmSettingsResponse response =
        service.getFcmSettings(new GetFcmSettingsRequest.Builder().entityId(entityId).build());
    assertNotNull(response);
  }
  ...
  public void testListEntityFuturesSweeps() throws Exception {
    ...
    ListEntityFuturesSweepsResponse response =
        service.listEntityFuturesSweeps(
            new ListEntityFuturesSweepsRequest.Builder().entityId(entityId).build());
    assertNotNull(response);
  }
