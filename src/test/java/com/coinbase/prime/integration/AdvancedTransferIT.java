...
public class AdvancedTransferIT extends BaseIntegrationTest {
  ...
  public void testListAdvancedTransfers() throws Exception {
    ...
    ListAdvancedTransfersResponse response =
        service.listAdvancedTransfers(
            new ListAdvancedTransfersRequest.Builder().portfolioId(portfolioId).build());
  ...
  public void testListAdvancedTransferTransactions() throws Exception {
    ...
    AdvancedTransferService service = PrimeServiceFactory.createAdvancedTransferService(client);
    ListAdvancedTransfersResponse transfers =
        service.listAdvancedTransfers(
            new ListAdvancedTransfersRequest.Builder().portfolioId(portfolioId).limit(1).build());

    assumeTrue(
        transfers != null
            && transfers.getAdvancedTransfers() != null
    ...
    ListAdvancedTransferTransactionsResponse response =
        service.listAdvancedTransferTransactions(
