...
public class StakingServiceSerializationTest {
  ...
  @Test
  public void testClaimRewardsRequestSerialization()
  ...
  public void testPortfolioStakingInitiateRequestSerialization() throws JsonProcessingException {
    PortfolioStakingInitiateRequest request =
        new PortfolioStakingInitiateRequest.Builder()
            .portfolioId("portfolio-123")
  ...
  public void testPortfolioStakingInitiateResponseDeserialization() throws JsonProcessingException {
    String json =
        "{" + "\"activity_id\":\"act-init-1\"," + "\"transaction_id\":\"txn-init-1\"" + "}";

    PortfolioStakingInitiateResponse response =
        objectMapper.readValue(json, PortfolioStakingInitiateResponse.class);
    assertNotNull(response);
  ...
  public void testPortfolioStakingUnstakeRequestSerialization() throws JsonProcessingException {
    PortfolioStakingUnstakeRequest request =
  ...
  public void testPortfolioStakingUnstakeResponseDeserialization() throws JsonProcessingException {
    String json =
        "{" + "\"activity_id\":\"act-unstake-1\"," + "\"transaction_id\":\"txn-unstake-1\"" + "}";

    PortfolioStakingUnstakeResponse response =
        objectMapper.readValue(json, PortfolioStakingUnstakeResponse.class);
    assertNotNull(response);
    assertEquals("act-unstake-1", response.getActivityId());
    assertEquals("txn-unstake-1", response.getTransactionId());
  }
  ...
  public void testGetStakingStatusResponseDeserialization() throws JsonProcessingException {
    ...
    GetStakingStatusResponse response =
        objectMapper.readValue(json, GetStakingStatusResponse.class);
    assertNotNull(response);
  ...
  public void testGetUnstakingStatusResponseDeserialization() throws JsonProcessingException {
    ...
    GetUnstakingStatusResponse response =
        objectMapper.readValue(json, GetUnstakingStatusResponse.class);
    assertNotNull(response);
    assertEquals("portfolio-123", response.getPortfolioId());
    assertEquals("wallet-456", response.getWalletId());
    assertNotNull(response.getValidators());
  ...
  @Test
  public void testListTransactionValidatorsResponseDeserialization()
    ...
    ListTransactionValidatorsResponse response =
        objectMapper.readValue(json, ListTransactionValidatorsResponse.class);
    assertNotNull(response);
