...
/**
 * Comprehensive unit tests for Orders service serialization/deserialization Tests ensure core
 * version upgrade maintains compatibility
 */
public class OrdersServiceSerializationTest {
  ...
  @Test
  public void testCreateOrderRequestSerialization()
  ...
  @Test
  public void testGetOrderPreviewRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
  ...
  @Test
  public void testListOpenOrdersRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
  ...
  @Test
  public void testListPortfolioOrdersRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
  ...
  public void testListPortfolioOrdersResponseDeserialization() throws JsonProcessingException {
    ...
    ListPortfolioOrdersResponse response =
        objectMapper.readValue(json, ListPortfolioOrdersResponse.class);
  ...
  public void testGetOrderByOrderIdResponseDeserialization() throws JsonProcessingException {
    ...
    GetOrderByOrderIdResponse response =
        objectMapper.readValue(json, GetOrderByOrderIdResponse.class);
  ...
  public void testCancelOrderRequestCreation() throws CoinbaseClientException {
    CancelOrderRequest request =
        new CancelOrderRequest.Builder().portfolioId("portfolio-123").orderId("order-789").build();
  ...
  @Test
  public void testListOrderFillsRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
  ...
  @Test
  public void testListPortfolioFillsRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
  ...
  public void testListPortfolioFillsResponseDeserialization() throws JsonProcessingException {
    ...
    ListPortfolioFillsResponse response =
        objectMapper.readValue(json, ListPortfolioFillsResponse.class);
  ...
  @Test
  public void testCreateQuoteRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
  ...
  @Test
  public void testAcceptQuoteRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
  ...
  public void testAcceptQuoteResponseDeserialization() throws JsonProcessingException {
    String json = "{" + "\"order_id\":\"order-from-quote\"" + "}";
  ...
  @Test
  public void testEditOrderRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
  ...
  public void testListOrderEditHistoryRequestCreation() throws CoinbaseClientException {
    ListOrderEditHistoryRequest request =
        new ListOrderEditHistoryRequest.Builder()
            .portfolioId("portfolio-123")
            .orderId("order-456")
            .build();
  ...
  public void testListOrderEditHistoryResponseDeserialization() throws JsonProcessingException {
    ...
    ListOrderEditHistoryResponse response =
        objectMapper.readValue(json, ListOrderEditHistoryResponse.class);
  ...
  public void testGetOrderPreviewRequestBuilderValidation() {
    GetOrderPreviewRequest.Builder builder =
        new GetOrderPreviewRequest.Builder().productId("ETH-USD").side(OrderSide.SELL);
