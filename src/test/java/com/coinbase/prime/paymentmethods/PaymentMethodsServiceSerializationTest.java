...
public class PaymentMethodsServiceSerializationTest {
  ...
  public void testListPaymentMethodsResponseDeserialization() throws JsonProcessingException {
    ...
    ListPaymentMethodsResponse response =
        objectMapper.readValue(json, ListPaymentMethodsResponse.class);
  ...
  public void testGetPaymentMethodDetailsRequestBuilderValidation() {
    assertThrows(
        CoinbaseClientException.class,
        () -> new GetPaymentMethodDetailsRequest.Builder().paymentMethodId("pm-456").build());
    assertThrows(
        CoinbaseClientException.class,
        () -> new GetPaymentMethodDetailsRequest.Builder().entityId("entity-123").build());
  }
  ...
  public void testGetPaymentMethodDetailsResponseDeserialization() throws JsonProcessingException {
    ...
    GetPaymentMethodDetailsResponse response =
        objectMapper.readValue(json, GetPaymentMethodDetailsResponse.class);
    assertNotNull(response);
