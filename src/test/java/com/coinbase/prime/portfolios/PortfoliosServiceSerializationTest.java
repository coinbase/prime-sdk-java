...
public class PortfoliosServiceSerializationTest {
  ...
  public void testGetPortfolioCounterpartyIdRequestConstruction() throws CoinbaseClientException {
    GetPortfolioCounterpartyIdRequest request =
        new GetPortfolioCounterpartyIdRequest.Builder("portfolio-123").build();
    assertNotNull(request);
    assertEquals("portfolio-123", request.getPortfolioId());
  }

  @Test
  public void testGetPortfolioCounterpartyIdResponseDeserialization()
    ...
    GetPortfolioCounterpartyIdResponse response =
        objectMapper.readValue(json, GetPortfolioCounterpartyIdResponse.class);
    assertNotNull(response);
