...
public class AllocationsServiceSerializationTest {
  ...
  public void testCreateAllocationResponseDeserialization() throws JsonProcessingException {
    String json =
        "{" + "\"body\":{" + "\"success\":true," + "\"allocation_id\":\"alloc-123\"" + "}" + "}";

    CreateAllocationResponse response =
        objectMapper.readValue(json, CreateAllocationResponse.class);
  ...
  public void testCreateNetAllocationRequestSerialization() throws JsonProcessingException {
    CreateNetAllocationRequest request =
        new CreateNetAllocationRequest.Builder()
            .sourcePortfolioId("portfolio-source")
            .productId("ETH-USD")
  ...
  public void testCreateNetAllocationResponseDeserialization() throws JsonProcessingException {
    ...
    CreateNetAllocationResponse response =
        objectMapper.readValue(json, CreateNetAllocationResponse.class);
    assertNotNull(response);
    assertNotNull(response.getBody());
    assertTrue(response.getBody().getSuccess());
  ...
  public void testListAllocationsByNettingIdRequestConstruction() throws CoinbaseClientException {
    ListAllocationsByNettingIdRequest request =
        new ListAllocationsByNettingIdRequest.Builder()
            .portfolioId("portfolio-123")
  ...
  @Test
  public void testListAllocationsByNettingIdResponseDeserialization()
    ...
    ListAllocationsByNettingIdResponse response =
        objectMapper.readValue(json, ListAllocationsByNettingIdResponse.class);
    assertNotNull(response);
  ...
  public void testListPortfolioAllocationsRequestConstruction() throws CoinbaseClientException {
    ListPortfolioAllocationsRequest request =
        new ListPortfolioAllocationsRequest.Builder()
            .portfolioId("portfolio-123")
  ...
  public void testListPortfolioAllocationsResponseDeserialization() throws JsonProcessingException {
    ...
    ListPortfolioAllocationsResponse response =
        objectMapper.readValue(json, ListPortfolioAllocationsResponse.class);
    assertNotNull(response);
    assertNotNull(response.getAllocations());
    assertEquals(2, response.getAllocations().length);
