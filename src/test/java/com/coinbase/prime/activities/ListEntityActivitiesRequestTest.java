...
public class ListEntityActivitiesRequestTest {
  ...
  public void testBuilderWithEnums() throws CoinbaseClientException {
    ...
    assertArrayEquals(
        new ActivityCategory[] {
          ActivityCategory.ACTIVITY_CATEGORY_ORDER, ActivityCategory.ACTIVITY_CATEGORY_TRANSACTION
        },
        request.getCategories());
    assertArrayEquals(
        new ActivityStatus[] {
          ActivityStatus.ACTIVITY_STATUS_COMPLETED, ActivityStatus.ACTIVITY_STATUS_PROCESSING
        },
        request.getStatuses());
  ...
  public void testSettersWithEnums() {
    ...
    assertArrayEquals(
        new ActivityCategory[] {ActivityCategory.ACTIVITY_CATEGORY_ACCOUNT},
        request.getCategories());
    assertArrayEquals(
        new ActivityStatus[] {ActivityStatus.ACTIVITY_STATUS_FAILED}, request.getStatuses());
  }
