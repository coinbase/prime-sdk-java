...
public class ConstantsTest {
  ...
  public void testSdkVersionIsCorrect() {
    assertEquals("1.10.3", Constants.SDK_VERSION, "SDK_VERSION should match the version in pom.xml");
  }
  ...
  public void testSdkVersionIsNotEmpty() {
    assertFalse(Constants.SDK_VERSION.trim().isEmpty(), "SDK_VERSION should not be empty");
  }
  ...
  public void testSdkVersionFollowsSemVer() {
    ...
    assertTrue(
        Constants.SDK_VERSION.matches(versionPattern),
  ...
  public void versionedBaseUrl_replacesTrailingVersionSegment_forPrimeV1ToV2() {
    ...
    assertEquals(
        "https://api.prime.coinbase.com/v2",
        v2Base,
