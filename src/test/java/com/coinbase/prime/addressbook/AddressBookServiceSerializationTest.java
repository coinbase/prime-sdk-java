...
public class AddressBookServiceSerializationTest {
  ...
  @Test
  public void testListAddressBookRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
    ListAddressBookRequest request =
  ...
  @Test
  public void testCreateAddressBookEntryRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
  ...
  public void testCreateAddressBookEntryResponseDeserialization() throws JsonProcessingException {
    ...
    CreateAddressBookEntryResponse response =
        objectMapper.readValue(json, CreateAddressBookEntryResponse.class);
    assertNotNull(response);
