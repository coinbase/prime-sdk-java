...
public class FuturesServiceSerializationTest {
  ...
  @Test
  public void testSetAutoSweepRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
    SetAutoSweepRequest request =
        new SetAutoSweepRequest.Builder().entityId("entity-123").autoSweep(true).build();
  ...
  public void testGetEntityFcmBalanceResponseDeserialization() throws JsonProcessingException {
    ...
    GetEntityFcmBalanceResponse response =
        objectMapper.readValue(json, GetEntityFcmBalanceResponse.class);
    assertNotNull(response);
  ...
  public void testGetPositionsRequestConstruction() throws CoinbaseClientException {
    GetPositionsRequest request =
        new GetPositionsRequest.Builder().entityId("entity-123").productId("BTC-PERP").build();
    assertNotNull(request);
    assertEquals("entity-123", request.getEntityId());
  ...
  public void testListEntityFuturesSweepsRequestConstruction() throws CoinbaseClientException {
    ListEntityFuturesSweepsRequest request =
        new ListEntityFuturesSweepsRequest.Builder().entityId("entity-123").build();
    assertNotNull(request);
    assertEquals("entity-123", request.getEntityId());
  }
  ...
  public void testListEntityFuturesSweepsResponseDeserialization() throws JsonProcessingException {
    ...
    ListEntityFuturesSweepsResponse response =
        objectMapper.readValue(json, ListEntityFuturesSweepsResponse.class);
    assertNotNull(response);
  ...
  public void testCancelEntityFuturesSweepRequestConstruction() throws CoinbaseClientException {
    CancelEntityFuturesSweepRequest request =
        new CancelEntityFuturesSweepRequest.Builder().entityId("entity-123").build();
    assertNotNull(request);
    assertEquals("entity-123", request.getEntityId());
  }
  ...
  public void testCancelEntityFuturesSweepResponseDeserialization() throws JsonProcessingException {
    ...
    CancelEntityFuturesSweepResponse response =
        objectMapper.readValue(json, CancelEntityFuturesSweepResponse.class);
    assertNotNull(response);
    assertTrue(response.getSuccess());
  ...
  @Test
  public void testScheduleEntityFuturesSweepRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
  ...
  @Test
  public void testScheduleEntityFuturesSweepResponseDeserialization()
      throws JsonProcessingException {
    String json = "{\"success\":true,\"request_id\":\"req-xyz789\"}";
    ScheduleEntityFuturesSweepResponse response =
        objectMapper.readValue(json, ScheduleEntityFuturesSweepResponse.class);
    assertNotNull(response);
    assertTrue(response.getSuccess());
  ...
  public void testGetFcmMarginCallDetailsRequestConstruction() throws CoinbaseClientException {
    GetFcmMarginCallDetailsRequest request =
        new GetFcmMarginCallDetailsRequest.Builder().entityId("entity-123").build();
    assertNotNull(request);
    assertEquals("entity-123", request.getEntityId());
  }
  ...
  public void testGetFcmMarginCallDetailsResponseDeserialization() throws JsonProcessingException {
    ...
    GetFcmMarginCallDetailsResponse response =
        objectMapper.readValue(json, GetFcmMarginCallDetailsResponse.class);
    assertNotNull(response);
  }
  ...
  public void testGetFcmRiskLimitsRequestConstruction() throws CoinbaseClientException {
    GetFcmRiskLimitsRequest request =
        new GetFcmRiskLimitsRequest.Builder().entityId("entity-123").build();
    assertNotNull(request);
    assertEquals("entity-123", request.getEntityId());
  }
  ...
  public void testGetFcmRiskLimitsResponseDeserialization() throws JsonProcessingException {
    ...
    GetFcmRiskLimitsResponse response =
        objectMapper.readValue(json, GetFcmRiskLimitsResponse.class);
    assertNotNull(response);
  ...
  public void testGetFcmSettingsRequestConstruction() {
    GetFcmSettingsRequest request =
        new GetFcmSettingsRequest.Builder().entityId("entity-123").build();
    assertNotNull(request);
    assertEquals("entity-123", request.getEntityId());
  }
  ...
  public void testGetFcmEquityRequestConstruction() {
    GetFcmEquityRequest request = new GetFcmEquityRequest.Builder().entityId("entity-123").build();
    assertNotNull(request);
    assertEquals("entity-123", request.getEntityId());
  }
