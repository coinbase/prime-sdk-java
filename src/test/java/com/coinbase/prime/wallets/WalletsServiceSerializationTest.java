...
public class WalletsServiceSerializationTest {
  ...
  @Test
  public void testCreateWalletDepositAddressRequestSerialization()
  ...
  @Test
  public void testCreateWalletDepositAddressResponseDeserialization()
    ...
    CreateWalletDepositAddressResponse response =
        objectMapper.readValue(json, CreateWalletDepositAddressResponse.class);
  ...
  @Test
  public void testCreateWalletDepositAddressResponseWithNullAccountIdentifier()
      throws JsonProcessingException {
  ...
  public void testListWalletAddressesResponseDeserialization() throws JsonProcessingException {
    ...
    ListWalletAddressesResponse response =
        objectMapper.readValue(json, ListWalletAddressesResponse.class);
  ...
  @Test
  public void testListWalletsRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
  ...
  public void testListWalletsRequestBuilderValidation() {
    assertThrows(CoinbaseClientException.class, () -> new ListWalletsRequest.Builder().build());
  }
  ...
  @Test
  public void testCreateWalletRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
  ...
  public void testGetWalletDepositInstructionsRequestConstruction() throws CoinbaseClientException {
    ...
    assertEquals("wallet-456", request.getWalletId());
    assertEquals(
        com.coinbase.prime.model.enums.WalletDepositInstructionType.CRYPTO,
  ...
  @Test
  public void testGetWalletDepositInstructionsCryptoResponseDeserialization()
      throws JsonProcessingException {
    String json =
        "{"
            + "\"crypto_instructions\":{"
    ...
    GetWalletDepositInstructionsResponse response =
        objectMapper.readValue(json, GetWalletDepositInstructionsResponse.class);
    assertNotNull(response);
  ...
  @Test
  public void testGetWalletDepositInstructionsFiatResponseDeserialization()
      throws JsonProcessingException {
    String json =
        "{"
            + "\"fiat_instructions\":{"
