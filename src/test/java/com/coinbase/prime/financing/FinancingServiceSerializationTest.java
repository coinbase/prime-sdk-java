...
public class FinancingServiceSerializationTest {
  ...
  public void testCreateNewLocatesRequestSerialization() throws JsonProcessingException {
    CreateNewLocatesRequest request =
        new CreateNewLocatesRequest.Builder()
  ...
  public void testCreateNewLocatesResponseDeserialization() throws JsonProcessingException {
    ...
    CreateNewLocatesResponse response =
        objectMapper.readValue(json, CreateNewLocatesResponse.class);
  ...
  public void testGetCrossMarginOverviewRequestConstruction() {
    GetCrossMarginOverviewRequest request =
        new GetCrossMarginOverviewRequest.Builder().entityId("entity-123").build();
  ...
  public void testGetCrossMarginOverviewResponseDeserialization() throws JsonProcessingException {
    ...
    GetCrossMarginOverviewResponse response =
        objectMapper.readValue(json, GetCrossMarginOverviewResponse.class);
    assertNotNull(response);
  ...
  @Test
  public void testGetEntityLocateAvailabilitiesRequestSerialization()
  ...
  @Test
  public void testGetEntityLocateAvailabilitiesResponseDeserialization()
      throws JsonProcessingException {
    String json =
        "{"
            + "\"locates\":["
    ...
    GetEntityLocateAvailabilitiesResponse response =
        objectMapper.readValue(json, GetEntityLocateAvailabilitiesResponse.class);
    assertNotNull(response);
  ...
  public void testGetMarginInformationRequestConstruction() {
    GetMarginInformationRequest request =
        new GetMarginInformationRequest.Builder().entityId("entity-456").build();
    assertNotNull(request);
  ...
  public void testGetMarginInformationResponseDeserialization() throws JsonProcessingException {
    ...
    GetMarginInformationResponse response =
        objectMapper.readValue(json, GetMarginInformationResponse.class);
    assertNotNull(response);
  ...
  public void testGetPortfolioBuyingPowerResponseDeserialization() throws JsonProcessingException {
    ...
    GetPortfolioBuyingPowerResponse response =
        objectMapper.readValue(json, GetPortfolioBuyingPowerResponse.class);
    assertNotNull(response);
  ...
  public void testGetPortfolioCreditInformationRequestConstruction() {
    GetPortfolioCreditInformationRequest request =
        new GetPortfolioCreditInformationRequest.Builder().portfolioId("portfolio-123").build();
    assertNotNull(request);
    assertEquals("portfolio-123", request.getPortfolioId());
  }

  @Test
  public void testGetPortfolioCreditInformationResponseDeserialization()
      throws JsonProcessingException {
    String json =
        "{"
            + "\"postTradeCredit\":{"
    ...
    GetPortfolioCreditInformationResponse response =
        objectMapper.readValue(json, GetPortfolioCreditInformationResponse.class);
    assertNotNull(response);
  }
  ...
  @Test
  public void testGetPortfolioWithdrawalPowerResponseDeserialization()
      throws JsonProcessingException {
    String json =
        "{"
            + "\"withdrawal_power\":{"
    ...
    GetPortfolioWithdrawalPowerResponse response =
        objectMapper.readValue(json, GetPortfolioWithdrawalPowerResponse.class);
    assertNotNull(response);
  ...
  @Test
  public void testGetTradeFinanceTieredPricingFeesRequestSerialization()
      throws JsonProcessingException {
  ...
  @Test
  public void testGetTradeFinanceTieredPricingFeesResponseDeserialization()
      throws JsonProcessingException {
    String json =
        "{"
            + "\"fees\":["
    ...
    GetTradeFinanceTieredPricingFeesResponse response =
        objectMapper.readValue(json, GetTradeFinanceTieredPricingFeesResponse.class);
    assertNotNull(response);
  ...
  public void testListExistingLocatesResponseDeserialization() throws JsonProcessingException {
    ...
    ListExistingLocatesResponse response =
        objectMapper.readValue(json, ListExistingLocatesResponse.class);
    assertNotNull(response);
    assertNotNull(response.getLocates());
    assertEquals(2, response.getLocates().length);
  }
  ...
  @Test
  public void testListFinancingEligibleAssetsResponseDeserialization()
      throws JsonProcessingException {
    String json =
        "{"
            + "\"assets\":["
    ...
    ListFinancingEligibleAssetsResponse response =
        objectMapper.readValue(json, ListFinancingEligibleAssetsResponse.class);
    assertNotNull(response);
  ...
  public void testListInterestAccrualsResponseDeserialization() throws JsonProcessingException {
    ...
    ListInterestAccrualsResponse response =
        objectMapper.readValue(json, ListInterestAccrualsResponse.class);
    assertNotNull(response);
  ...
  @Test
  public void testListInterestAccrualsForPortfolioResponseDeserialization()
      throws JsonProcessingException {
    String json =
        "{"
    ...
    ListInterestAccrualsForPortfolioResponse response =
        objectMapper.readValue(json, ListInterestAccrualsForPortfolioResponse.class);
    assertNotNull(response);
  ...
  public void testListMarginCallSummariesResponseDeserialization() throws JsonProcessingException {
    ...
    ListMarginCallSummariesResponse response =
        objectMapper.readValue(json, ListMarginCallSummariesResponse.class);
    assertNotNull(response);
  ...
  public void testListMarginConversionsResponseDeserialization() throws JsonProcessingException {
    ...
    ListMarginConversionsResponse response =
        objectMapper.readValue(json, ListMarginConversionsResponse.class);
    assertNotNull(response);
  ...
  public void testListTradeFinanceObligationsRequestConstruction() throws Exception {
    ListTradeFinanceObligationsRequest request =
        new ListTradeFinanceObligationsRequest.Builder().entityId("entity-123").build();
    assertNotNull(request);
    assertEquals("entity-123", request.getEntityId());
  }

  @Test
  public void testListTradeFinanceObligationsResponseDeserialization()
      throws JsonProcessingException {
    String json =
        "{"
            + "\"obligations\":["
