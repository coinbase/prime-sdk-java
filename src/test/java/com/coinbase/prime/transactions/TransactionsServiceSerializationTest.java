...
public class TransactionsServiceSerializationTest {
  ...
  @Test
  public void testListPortfolioTransactionsRequestSerialization()
  ...
  @Test
  public void testListPortfolioTransactionsResponseDeserialization()
    ...
    ListPortfolioTransactionsResponse response =
        objectMapper.readValue(json, ListPortfolioTransactionsResponse.class);
  ...
  @Test
  public void testCreateConversionRequestSerialization()
      throws CoinbaseClientException, JsonProcessingException {
  ...
  public void testCreateConversionResponseDeserialization() throws JsonProcessingException {
    ...
    CreateConversionResponse response =
        objectMapper.readValue(json, CreateConversionResponse.class);
    assertNotNull(response);
  ...
  @Test
  public void testCreateOnchainTransactionRequestSerialization()
      throws JsonProcessingException, com.coinbase.core.errors.CoinbaseClientException {
    com.coinbase.prime.model.RpcConfig rpc =
        new com.coinbase.prime.model.RpcConfig.Builder().url("https://rpc.example.com").build();
    CreateOnchainTransactionRequest request =
        new CreateOnchainTransactionRequest.Builder()
            .portfolioId("portfolio-123")
            .walletId("wallet-456")
  ...
  public void testCreateOnchainTransactionResponseDeserialization() throws JsonProcessingException {
    ...
    CreateOnchainTransactionResponse response =
        objectMapper.readValue(json, CreateOnchainTransactionResponse.class);
    assertNotNull(response);
  ...
  public void testListWalletTransactionsResponseDeserialization() throws JsonProcessingException {
    ...
    ListWalletTransactionsResponse response =
        objectMapper.readValue(json, ListWalletTransactionsResponse.class);
    assertNotNull(response);
    assertNotNull(response.getTransactions());
    assertEquals(2, response.getTransactions().length);
  }
  ...
  public void testCreateWalletTransferResponseDeserialization() throws JsonProcessingException {
    ...
    CreateWalletTransferResponse response =
        objectMapper.readValue(json, CreateWalletTransferResponse.class);
    assertNotNull(response);
  ...
  public void testCreateWalletWithdrawalResponseDeserialization() throws JsonProcessingException {
    ...
    CreateWalletWithdrawalResponse response =
        objectMapper.readValue(json, CreateWalletWithdrawalResponse.class);
    assertNotNull(response);
  ...
  @Test
  public void testListAdvancedTransferTransactionsResponseDeserialization()
      throws JsonProcessingException {
    String json =
        "{"
            + "\"transactions\":["
    ...
    ListAdvancedTransferTransactionsResponse response =
        objectMapper.readValue(json, ListAdvancedTransferTransactionsResponse.class);
    assertNotNull(response);
    assertNotNull(response.getTransactions());
  ...
  @Test
  public void testGetTransactionTravelRuleDataResponseDeserialization()
      throws JsonProcessingException {
    String json =
        "{"
    ...
    GetTransactionTravelRuleDataResponse response =
        objectMapper.readValue(json, GetTransactionTravelRuleDataResponse.class);
    assertNotNull(response);
  }
  ...
  @Test
  public void testSubmitDepositTravelRuleDataResponseDeserialization()
      throws JsonProcessingException {
    String json = "{}";
    SubmitDepositTravelRuleDataResponse response =
        objectMapper.readValue(json, SubmitDepositTravelRuleDataResponse.class);
    assertNotNull(response);
  }
}
